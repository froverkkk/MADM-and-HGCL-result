...
def parse_args():
    ...
    parser.add_argument('--data_format', default='links_rating', choices=['pkl', 'links_rating'],
                        help=' pkl or links_rating')
    parser.add_argument('--data_dir', default='data',
                        help='data')

    parser.add_argument('--neg', default=1, type=int, help='neg sample')
